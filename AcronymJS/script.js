function process() {
	...
	const reportInHTML = document.getElementById("display");

	var foundInArray = false;
	// (l. 8) --> Truth test: start by assuming it is false (not found in Array) [utilization of reverse logical operator // single bang]
